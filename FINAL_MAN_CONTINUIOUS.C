...
int main()
{
	int x = 300, y = 300, speed = 300;
	char a = 'd';
	int gd = DETECT, gm;
	clrscr();
	// Make sure you provide right Path. If BGI folder location is C:\TurboC++\Disk\TurboC3\BGI then provide C:\\TurboC3\\BGI.
